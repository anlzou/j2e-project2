...
//    public void suploadfile(@RequestParam("up1oadfile") MultipartFile up1oadfile,HttpServletRequest request,HttpServletResponse response){
//        /*获取上传文件的文件名*/
...
//    public void muploadfile(@RequestParam("up1oadfile") List<MultipartFile> up1oadfile, HttpServletRequest request, HttpServletResponse response){
//        /*设置上传文件的保存地址目录*/
//        String path=request.getServletContext().getRealPath("/upload/");
//        File filePath=new File(path);
//        /*判断保存上传文件的目录是否存在，若没有存在则进行创建*/
